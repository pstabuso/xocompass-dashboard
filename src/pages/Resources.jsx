...
const Resources = () => {
  ...
  return (
    <div className="space-y-6 animate-enter">
      <h2 className="text-2xl font-bold text-slate-100">External Resources</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {resources.map((res, idx) => (
          <div
            key={idx}
            onClick={res.action ? res.action : () => window.open(res.link, '_blank')}
            className="group block bg-slate-900/50 p-6 rounded-xl border border-slate-800 cursor-pointer transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1 hover:border-sky-500/30 active:scale-95"
          >
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-enter">
          <div className="relative bg-slate-900 rounded-3xl shadow-2xl w-full max-w-6xl h-auto max-h-[90vh] flex flex-col overflow-hidden border border-slate-700">
            ...
            <button
                ...
                className="absolute top-4 right-4 z-50 p-2 bg-slate-800/80 backdrop-blur text-slate-400 rounded-full hover:bg-red-500/15 hover:text-red-400 transition-all shadow-sm border border-slate-700"
            >
                <X size={24} />
            </button>

            <div className="p-8 border-b border-slate-800 flex justify-between items-center bg-slate-800/30 backdrop-blur">
              <div>
                <h3 className="text-2xl font-bold text-slate-100">Model Architecture Justification</h3>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-4 min-w-[900px]">
                ...
                {/* HEADERS */}
                <div className="col-span-1 p-6 bg-slate-800/30 border-b border-r border-slate-700 sticky top-0 z-10">
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-widest">Criterion</span>
                </div>
                <div className="col-span-1 p-6 bg-slate-900 border-b border-r border-slate-700 text-center sticky top-0 z-10">
                   <h4 className="font-bold text-lg text-slate-400">ARIMA</h4>
                   <p className="text-[10px] text-slate-500">Standard Univariate</p>
                </div>
                <div className="col-span-1 p-6 bg-slate-900 border-b border-r border-slate-700 text-center sticky top-0 z-10">
                   <h4 className="font-bold text-lg text-sky-400">SARIMA</h4>
                   <p className="text-[10px] text-slate-500">Seasonal Univariate</p>
                </div>
                <div className="col-span-1 p-6 bg-slate-950 border-b border-slate-700 text-center sticky top-0 z-10 shadow-xl">
                ...
                {/* ROW 1: SEASONALITY */}
                <div className="col-span-1 p-6 bg-slate-800/30 border-b border-r border-slate-700 flex flex-col justify-center">
                ...
                <div className="col-span-1 p-6 bg-slate-900 border-b border-r border-slate-700 text-sm text-slate-400">
                ...
                <div className="col-span-1 p-6 bg-slate-900 border-b border-slate-700 text-sm text-slate-300 bg-emerald-500/5">
                    <div className="flex items-center gap-2 text-emerald-400 font-bold mb-1"><Check size={16}/> Excellent</div>
                ...
                <div className="col-span-1 p-6 bg-slate-900 border-b border-slate-700 text-sm text-slate-300 bg-emerald-500/5 border-l-4 border-l-emerald-500">
                ...
                {/* ROW 3: COMPLEXITY */}
                <div className="col-span-1 p-6 bg-slate-800/30 border-r border-slate-700 flex flex-col justify-center">
                ...
                <div className="col-span-1 p-6 bg-slate-900 border-r border-slate-700 text-sm text-slate-400">
                ...
                <div className="col-span-1 p-6 bg-slate-900 border-slate-700 text-sm text-slate-300 bg-emerald-500/5">
